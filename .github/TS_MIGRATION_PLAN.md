...
CI has been consolidated into a single pnpm-based workflow (`.github/workflows/ci.yml`) covering lint, type-check, test, and build. Coverage upload via Codecov has been removed.
